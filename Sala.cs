...
namespace AgendaSalas
{
    class Sala
    {
        ...
        public Sala(int id, string identificacao, int medidaLado1EmMetros, int medidalado2EmMetros, int numeroMaximoDePessoas, int janelas, bool temBanheiro, bool temEstacionamento, bool temArCondicionado, bool temSeguro, Endereco endereco)
        {
            _id = id;
            _identificacao = identificacao;
            _medidaLado1EmMetros = medidaLado1EmMetros;
            _medidalado2EmMetros = medidalado2EmMetros;
        ...
        {
            return "Id: " + Id + " \nIdentificação: " + Identificacao + " \nMedida Lado 1 (Metros): " + MedidaLado1EmMetros + " \nMedida Lado 2 (Metros): " + Medidalado2EmMetros + " \nNumero Maximo De Pessoas: " + NumeroMaximoDePessoas + " \nQuantidade de Janelas: " + Janelas + " \nPossui banheiro: " + TemBanheiro + " \nPossui estacionamento: " + TemEstacionamento + " \nPossui Ar-Condicionado: " + TemArCondicionado + " \nPossui Seguro: " + TemSeguro + " \nEndereço: " + Localizacao;
        }
    }
}
